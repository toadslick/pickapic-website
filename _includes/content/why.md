...
There are many tools available to help individuals develop communication skills, all of which come with strengths and weaknesses. The
[Picture Exchange Communication System](https://pecsusa.com/pecs/) (PECS) is a manualized, evidence-based system that focuses on developing the motivation to communicate by using exchangeable pictures to represent items and activities. However, many families express frustration with making and maintaining the required physical materials. Not having the right picture at a given moment may derail the motivation to communicate.
